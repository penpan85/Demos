...
import com.codepath.example.servicesnotificationsdemo.services.MusicService;
import com.codepath.example.servicesnotificationsdemo.services.MusicService.MyBinder;
	...
	private BroadcastReceiver mReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (action.equals("com.music.end")) {
				Toast.makeText(MusicPlayerActivity.this, intent.getCharSequenceExtra("hint"), 2000).show();
